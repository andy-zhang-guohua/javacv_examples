 ...
 * at andy.javacv.ObjectDetectionInMonitor.main(ObjectDetectionInMonitor.java:55)
 * 问题1 方案 :
...
public class ObjectDetectionInMonitor {
    public static void main(String[] args) throws Exception {
        ...
        if (args.length > 0) {
            ...
            // 如果没有网络支持，使用这种方案
            File file = Loader.extractResource(ObjectDetectionInMonitor.class, "/Itseez/opencv/2.4.0/data/haarcascades/haarcascade_frontalface_alt.xml", null, "classifier", ".xml");
            file.deleteOnExit();
        ...
        CanvasFrame frame = new CanvasFrame("视频监控对象识别", CanvasFrame.getDefaultGamma() / grabber.getGamma());
